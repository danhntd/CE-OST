...
if __name__ == '__main__':
    ...
    for i in tqdm(camopp_train_dataset_dicts):
        ...
        save_path = data_root + "COD10K-v3/Train_Image_CAM_white_hed/" + i['file_name'].split("/")[-1]
        ...
        if os.path.getsize(img_path) > 1000000 or img.shape[0] > 1000 or img.shape[1] > 1000:     
            ...
            root_temp = "./CE-OST/contour_emphasis/white_temp/"
    ...
    # with open('./CE-OST/contour_emphasis/white/apply_hed_white.txt', 'w') as f1:
    #     for item in apply_hed:
    #         f1.write("%s\n" % item)
        
    # with open('./CE-OST/contour_emphasis/white/non_apply_hed_white.txt', 'w') as f2:
