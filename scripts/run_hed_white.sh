...
config=configs/CIS_PVTv2B2Li_white_hed.yaml
...
config=configs/CIS_RT_white_hed.yaml
...
config=configs/CIS_R101_white_hed.yaml
...
config=configs/CIS_SWINT_white_hed.yaml
...
config=configs/CIS_R50_white_hed.yaml
